...
def get_codeforces_stats(username: str):
    ...
    try:
        ...
        if user_response.status_code == 200:
            ...
            # You can plot these on frontend using Recharts or Chart.js
            graph_points = [
                {
            ...
            return {
                ...
                "ratingHistory": graph_points  # for graph on frontend
            }
...
def get_codechef_stats(username: str):
    ...
    try:
        ...
        max_rating = soup.find("div", class_="rating-header").find_all("small")[0].text.strip().split()[-1]
        stars = soup.find("span", class_="rating").text.strip().split()[0]  # e.g., ★★★
